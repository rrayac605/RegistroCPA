...
import mx.gob.imss.cit.dictamen.individuo.to.PersonaTO;
...
public class DocumentoProbatorioTO extends BaseTO {
	...
	private DocumentosPorTipoTO documentoPorTipo;
	 ...
	 */
	public DocumentosPorTipoTO getDocumentoPorTipo() {
		return documentoPorTipo;
	}
	/**
	 * @param documentoPorTipo the documentoPorTipo to set
	 */
	public void setDocumentoPorTipo(DocumentosPorTipoTO documentoPorTipo) {

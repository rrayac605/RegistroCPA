...
import mx.gob.imss.cit.dictamen.persistence.dao.impl.NdtR3ColegioXcontadorDAOImpl;
...
public class NdtR3ColegioXcontadorDAOTest extends AbstractDBTestUnit {
	...
	private static final Logger LOG = Logger.getLogger(NdtR3ColegioXcontadorDAOTest.class);
	...
	public void testFindAll() {
		LOG.info("prueba");
		List<NdtR3ColegioXcontadorDO> resultList = localDAO.findAll();

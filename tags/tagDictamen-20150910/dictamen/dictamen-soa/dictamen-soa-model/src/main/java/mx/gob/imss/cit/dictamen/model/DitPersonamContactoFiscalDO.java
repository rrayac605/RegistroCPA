...
public class DitPersonamContactoFiscalDO implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + (int) (cveIdPmcontFiscal ^ (cveIdPmcontFiscal >>> 32));

...
@Entity
@Table(name="NDT_PERSONA_CBV_TEMP")
@NamedQuery(name="NdtPersonaCbvTemp.findAll", query="SELECT n FROM NdtPersonaCbvTemp n")
public class NdtPersonaCbvTemp implements Serializable {
	
	private static final long serialVersionUID = 7967719035434350699L;

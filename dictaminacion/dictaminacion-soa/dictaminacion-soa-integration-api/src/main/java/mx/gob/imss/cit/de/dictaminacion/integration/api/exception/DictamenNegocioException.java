package mx.gob.imss.cit.de.dictaminacion.integration.api.exception;
...
public class DictamenNegocioException extends Exception
{
   ...
   * Constructor base
   */
  public DictamenNegocioException()
  {
    super();
  }
   ...
   */
  public DictamenNegocioException( String message )
  {
    super( message );
  }
   ...
   */
  public DictamenNegocioException( String message, Throwable cause )
  {
    super( message, cause );
  }
   ...
   * @param cause Causa de error
   */
  public DictamenNegocioException( Throwable cause )
  {
    super( cause );
  }

...
@Entity
@NamedQueries({ @NamedQuery(name = "NdvColegios.findAll", query = "select o from NdvColegios o") })
@Table(name = "NDV_COLEGIOS")
public class NdvColegios implements Serializable {

	private static final long serialVersionUID = -4936690471245985445L;

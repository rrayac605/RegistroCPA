...
public class DomicilioCarreteraTO extends BaseTO {
	...
	private TipoTerminiGeneralTO terminoGeneral;
	/**
	 ...
	 */
	public TipoTerminiGeneralTO getTerminoGeneral() {
		return terminoGeneral;
	}
	/**
	 * @param terminoGeneral the terminoGeneral to set
	 */
	public void setTerminoGeneral(TipoTerminiGeneralTO terminoGeneral) {

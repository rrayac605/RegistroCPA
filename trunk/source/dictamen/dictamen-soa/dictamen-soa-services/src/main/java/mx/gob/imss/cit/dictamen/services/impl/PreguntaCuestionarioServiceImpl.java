...
public class PreguntaCuestionarioServiceImpl implements PreguntaCuestionarioService {
	 ...
	 */
	@Override
	public List<PreguntaCuestionarioTO> findCuestionarioById(Integer idCuestionario) throws DictamenException{

		LOG.info("obteneropciones casos especiales");
		List<PreguntaCuestionarioTO> tiposSolicitud = new ArrayList<PreguntaCuestionarioTO>();

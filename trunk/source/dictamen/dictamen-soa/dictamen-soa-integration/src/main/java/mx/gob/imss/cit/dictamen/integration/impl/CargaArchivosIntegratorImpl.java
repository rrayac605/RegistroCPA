...
public class CargaArchivosIntegratorImpl implements CargaArchivosIntegrator {
	...
	public boolean registrarCargaAseveracion(
		...
		aseveracionTO.setCveIdAseveracion(cargaAseveracionesDTO
				.getCveIdAseveracion().longValue());
		cveIdTipoDocumento
				.setCveIdTipoDocumento(TipoDocumentoEnum.TIPO_DOCUMENTO_ASEVERACIONES);
		patronDictamenTO.setCveIdPatronDictamen(cargaAseveracionesDTO
				.getCveIdPatronDictamen());

		CargaDocumentoTO cargaAseveracionesTO = new CargaDocumentoTO();
		cargaAseveracionesTO.setCveIdStatusCarga(estatus);
		cargaAseveracionesTO.setCveIdUsuario(cargaAseveracionesDTO
				.getCveIdUsuario());

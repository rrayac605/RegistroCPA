...
public final class DictamenExceptionBuilder
{
   ...
   */
  public static DictamenContadorException build( ContadorExceptionCodeEnum code )
  {
   ...
   * @return ExcepciÃ³n SolicitudPensionServiciosNegocioException
   */
  public static DictamenContadorException build( int code )
  {
   ...
   * @return ExcepciÃ³n SolicitudPensionServiciosNegocioException
   */
  public static DictamenContadorException build( int code, Object[] args )
  {
   ...
   * @return ExcepciÃ³n SolicitudPensionServiciosNegocioException
   */
  public static DictamenContadorException build( ContadorExceptionCodeEnum code, Object[] args )
  {
   ...
   * @return ExcepciÃ³n SolicitudPensionServiciosNegocioException
   */
  public static DictamenContadorException build( int code, Throwable cause )
  {
   ...
   * @return ExcepciÃ³n SolicitudPensionServiciosNegocioException
   */
  public static DictamenContadorException build( ContadorExceptionCodeEnum code, Throwable cause )
  {
   ...
   * @return ExcepciÃ³n SolicitudPensionServiciosNegocioException
   */
  public static DictamenContadorException build( ContadorExceptionCodeEnum code, Throwable cause, Object[] args )
  {
   ...
   * @return ExcepciÃ³n SolicitudPensionServiciosNegocioException
   */
  public static DictamenContadorException build( int code, Throwable cause, Object[] args )
  {
    Date date = new Date();
    DictamenContadorException dictamenException = null;
    
    if( cause != null ) {
    	dictamenException = new DictamenContadorException( cause.getMessage(), cause );
    }
    else{
    	String msg="";//PropertiesConfigUtils.getPropertyException(PREFIJO_MENSAJE_EXCEPCION+code,args);   
    	dictamenException = new DictamenContadorException(msg);
    }
   ...
   * @return ExcepciÃ³n SolicitudPensionServiciosNegocioException
   */
  public static DictamenContadorException build()
  {
    return build( ContadorExceptionCodeEnum.ERROR_DESCONOCIDO );
  }

...
public class CedulaPagosDiferenciasDTO implements Serializable {
	/**
	 * 
	 */
	...
	private PatronAsociadoDTO cveIdPatronAsociado;

	public CedulaPagosDiferenciasDTO() {
	}

	public CedulaPagosDiferenciasDTO(Long cveIdCedulaPagos) {
	...
	public PatronAsociadoDTO getCveIdPatronAsociado() {
		return cveIdPatronAsociado;
	}

	public void setCveIdPatronAsociado(PatronAsociadoDTO cveIdPatronAsociado) {

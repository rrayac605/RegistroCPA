 ...
 * @author ajfuentes
 */
public class PatronAsociadoTO  extends BaseTO {
    ...
    public PatronAsociadoTO(Long cveIdPatronAsociado) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PatronAsociadoTO)) {
            return false;
        }
        PatronAsociadoTO other = (PatronAsociadoTO) object;

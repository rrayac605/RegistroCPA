...
<script type="text/javascript" src="<spring:url value="/static/resources/js/dictamenV2/contador/actualizacion/actualizacionContador.js" htmlEscape="true" />"></script>
...
<div class="row">
	<h2><spring:message code="label.menu.servicios.titulo.actualizacion"/></h2>
	<hr class="red">
</div>
<div id="idDivSubtituloPasoUno" class="row">
	<h5><spring:message code="label.actualizacion.contador.subtitulo.paso.uno.tramite"/></h5>
</div>
<div id="idDivSubtituloPasoDos" class="row">
	<h5><spring:message code="label.actualizacion.contador.subtitulo.paso.dos.tramite"/></h5>
</div>
<div id="idDivSubtituloPasoTres" class="row">
	<h5><spring:message code="label.actualizacion.contador.subtitulo.paso.tres.tramite"/></h5>
</div>
<br/>
<div id="idDivSeleccionActualizacionDatos" class="form-group">
	<label style="text-align: left;" class="col-md-2 control-label" for="profesionista">
		<h5><spring:message code="label.actualizacion.contador.combo"/></h5>
	</label>
   	<div class="col-sm-8">
		<select id="idSltMostrarDatos" name="sltMostrarDatos" class="form-control">
			<option value="1">Datos Personales</option>
			<option value="2">Datos Despacho</option>
			<option value="3">Datos Colegio</option>
		</select>
	</div>
</div>
<br/>

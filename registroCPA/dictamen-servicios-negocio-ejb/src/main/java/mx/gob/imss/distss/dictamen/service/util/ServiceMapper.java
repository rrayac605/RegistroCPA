...
public class ServiceMapper {
	...
	/**
	 * Variable que referencia a la clase Mapper de la librería dozer.
	 */
	...
	/**
	 * Método que instancia la clase Mapper en dado caso que sea nula.
	 * 
	...
	/**
	 * Método que settea los valores de los atributos del Objeto fuente
	 * al Objeto destino. Los valores que se setean solo serán los que 
	 ...
	 * @param claseDestino Es el Objeto destino donde serán seteados los valores de los atributos del objeto fuente.
	...
	/**
	 * Método que settea los valores de los atributos de la lista de Objetos fuente
	 * a la lista de los Objetos destino. Los valores que se setean solo serán los que 
	 * cuentan con el mismo nombre y el mismo tipo de atributo.
	 * 
	 * @param lista Lista de objetos que contienen los valores de los atributos, lista de objetos fuentes.
	 * @param claseDestino Lista de objetos destino donde serán seteados los valores de los atributos del objeto fuente.

...
@Entity
@Table(name="NDC_PERSONA_MORAL_CBV_TEMP")
@NamedQuery(name="NdcPersonaMoralCbvTemp.findAll", query="SELECT n FROM NdcPersonaMoralCbvTemp n")
public class NdcPersonaMoralCbvTemp implements Serializable {
	
	private static final long serialVersionUID = -180286113635606512L;

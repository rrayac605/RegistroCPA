...
import mx.gob.imss.cit.dictamen.persistence.dao.impl.NdcTipoConvenioCotizacionDAOImpl;
...
public class NdcTipoConvenioCotizacionDAOTest extends AbstractDBTestUnit {
	...
	private static final Logger LOG = Logger.getLogger(NdcTipoConvenioCotizacionDAOTest.class);
	...
	public void testFindAll() {
		LOG.info("prueba");
		List<NdcTipoConvenioCotizacionDO> resultList = localDAO.findAll();

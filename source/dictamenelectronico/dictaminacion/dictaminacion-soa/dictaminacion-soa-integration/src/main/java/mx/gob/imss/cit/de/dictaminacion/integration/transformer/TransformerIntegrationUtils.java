...
public class TransformerIntegrationUtils {
	...
	static{
		...
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaDocumentoTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaDocumentoDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaActorTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaActorDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaMetadataTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaMetadataDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaTramiteTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaTramiteDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaBaseObjectTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaBaseObjectDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaHeaderTO.class,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaHeaderDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.FirmaElectronicaTO.class,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.FirmaElectronicaDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.LayoutTO.class,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.LayoutDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.ParentLayoutTO.class,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.ParentLayoutDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.AWSPolicyTO.class,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.AWSPolicyDTO.class);						
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaDocumentoDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaDocumentoTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaActorDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaActorTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaMetadataDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaMetadataTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaTramiteDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaTramiteTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaBaseObjectDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaBaseObjectTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.BovedaHeaderDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.BovedaHeaderTO.class);		
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.FirmaElectronicaDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.FirmaElectronicaTO.class);	
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.LayoutDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.LayoutTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.ParentLayoutDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.ParentLayoutTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.AWSPolicyDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.AWSPolicyTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.EjercicioFiscalDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.EjercicioFiscalTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.EjercicioFiscalTO.class,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.EjercicioFiscalDTO.class);		
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.TipoDictamenDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.TipoDictamenTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.TipoDictamenTO.class,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.TipoDictamenDTO.class);		
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.PatronDictamenTO.class,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.PatronDictamenDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.PatronDictamenDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.PatronDictamenTO.class);
		
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.RubroTO.class			,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.RubroDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.PreguntaTO.class		,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.PreguntaDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.OpcionPreguntaTO.class	,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.OpcionPreguntaDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.TipoRespuestaDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.TipoRespuestaTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.RubroDTO.class		,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.RubroTO.class			);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.PreguntaDTO.class		,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.PreguntaTO.class		);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.OpcionPreguntaDTO.class	,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.OpcionPreguntaTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.TipoRespuestaTO.class,     mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.TipoRespuestaDTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.AtestiguamientoTO.class			,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.AtestiguamientoDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.AtestiguamientoDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.AtestiguamientoTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.AtestiguamientoDictamenTO.class			,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.AtestiguamientoDictamenDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.AtestiguamientoDictamenDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.AtestiguamientoDictamenTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.EstadoAtestiguamientoTO.class			,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.EstadoAtestiguamientoDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.EstadoAtestiguamientoDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.EstadoAtestiguamientoTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.EstadoCargaDocumentoTO.class			,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.EstadoCargaDocumentoDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.EstadoCargaDocumentoDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.EstadoCargaDocumentoTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.PatronAsociadoDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.PatronAsociadoTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.PatronAsociadoTO.class,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.PatronAsociadoDTO.class	);	
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.RubroAtestiguamientoDictTO.class			,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.RubroAtestiguamientoDictDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.RubroAtestiguamientoDictDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.RubroAtestiguamientoDictTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.AtestigPreguntasRespuestTO.class			,mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.AtestigPreguntasRespuestDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.AtestigPreguntasRespuestDTO.class,mx.gob.imss.cit.de.dictaminacion.commons.to.domain.AtestigPreguntasRespuestTO.class	);
		
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.CedulaRemuneracionesTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.CedulaRemuneracionesDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.CedulaRemuneracionesDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.domain.CedulaRemuneracionesTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.DetFondoAhorroTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.DetFondoAhorroDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.DetFondoAhorroDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.domain.DetFondoAhorroTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.DetOtrosIngXsalarioTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.DetOtrosIngXsalarioDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.DetOtrosIngXsalarioDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.domain.DetOtrosIngXsalarioTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.DetOtrosPagXseparacTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.DetOtrosPagXseparacDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.DetOtrosPagXseparacDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.domain.DetOtrosPagXseparacTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.DetPagosOtrosEmpleadTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.DetPagosOtrosEmpleadDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.DetPagosOtrosEmpleadDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.domain.DetPagosOtrosEmpleadTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.CedulaPrestacionesTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.CedulaPrestacionesDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.CedulaPrestacionesDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.domain.CedulaPrestacionesTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.CedulaPagosDiferenciasTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.CedulaPagosDiferenciasDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.CedulaPagosDiferenciasDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.domain.CedulaPagosDiferenciasTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.PrestacionesTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.PrestacionesDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.PrestacionesDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.domain.PrestacionesTO.class	);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.commons.to.domain.RemuneracionesTO.class, mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.RemuneracionesDTO.class);
		mapClass.put(mx.gob.imss.cit.de.dictaminacion.integration.api.dto.domain.RemuneracionesDTO.class, mx.gob.imss.cit.de.dictaminacion.commons.to.domain.RemuneracionesTO.class	);
	}

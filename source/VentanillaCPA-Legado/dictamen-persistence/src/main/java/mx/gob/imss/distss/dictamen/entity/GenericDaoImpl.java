...
import mx.gob.imss.distss.dictamen.interfaces.GenericDao;
...
public class GenericDaoImpl<T, PK extends Serializable> extends AbstractRepository implements GenericDao<T, PK> {
